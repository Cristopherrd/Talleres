...
En mi opinión, la sintaxis de Python es más fácil de entender que la de Shell y Scala, porque es más clara y parecida al lenguaje natural. En cambio, en Shell los comandos pueden ser un poco confusos y en Scala la estructura es más formal. Por eso, trabajar con Python se me hace más simple y rápido de aprender.
...
```scala
@main def functionalAverage(): Unit =
  val nums = List(10, 20, 30, 40)
  val average = getAverage(nums)
  println(s"El promedio es: $average")
